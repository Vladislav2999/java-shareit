...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Optional<Booking> findByEndIsBeforeAndItemOwnerIdAndItemId(LocalDateTime now, Long userId, Long itemId, Sort sort);

    Optional<Booking> findByStartIsAfterAndItemOwnerIdAndItemId(LocalDateTime now, Long userId, Long itemId, Sort sort);
